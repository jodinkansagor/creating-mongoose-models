...
describe('Tarot model', () => {
  ...
  it('has a required majorArcana value', () => {
    const tarot = new Tarot({
  ...
  it('has a required minorArcana value', () => {
    const tarot = new Tarot({
